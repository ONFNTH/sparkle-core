package org.sparklely.sparkle.core.util.ctlib.plugin.util;

import net.byteflux.libby.Library;
import net.byteflux.libby.LibraryManager;
import org.sparklely.sparkle.core.util.ctlib.common.network.PingTest;
...
public class LibrariesLoader {
    ...
    public static void setManager(final LibraryManager manager){
        ...
        addRepository("http://dist.wso2.org/maven2/");
    }
